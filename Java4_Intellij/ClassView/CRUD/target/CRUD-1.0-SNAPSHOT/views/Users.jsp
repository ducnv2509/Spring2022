                ...
                <div class="col">
                    <form action="UserServlet" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fullName" class="form-control" value="${user.address}">
                        </div>


                        <div class="form-group">
                            <label for="">Phone</label>
                            <input type="text" name="fullName" class="form-control" value="${user.phone}">
                        </div>
                        <div class="mb-3">
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="item" items="${users}">
                                ...
                                <tr>
                                    ...
                                    <td>${item.address}</td>
                                    <td>
                                        <a href="UserServlet/edit?userId=${item.id}">
                                            Edit
                                        </a>
                                        <a href="UserServlet/delete?userId=${item.id}">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
