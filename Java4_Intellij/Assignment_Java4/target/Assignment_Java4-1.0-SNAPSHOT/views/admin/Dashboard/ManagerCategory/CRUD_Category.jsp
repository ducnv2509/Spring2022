            ...
            <div class="modal-body">
                <form action="CategoryServlet" method="post">
                    ...
                    <div class="form-check mt-4">
                        <button class="btn btn-primary" formaction="CategoryServlet/store">Create</button>
                        <button class="btn btn-info" formaction="CategoryServlet/reset">Reset</button>
                    </div>
                </form>
            </div>
            ...
            <c:forEach items="${category}" var="category">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger"
                                                    formaction="CategoryServlet/delete?id=${category.id}"
                                            >Xoá
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="exampleModal_edit${category.id}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel_edit${category.id}">Modal
                                    title</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                                ...
                                <form action="CategoryServlet" method="post">
                                    ...
                                    <div class="form-check mt-4">
                                        <button class="btn btn-warning"
                                                formaction="CategoryServlet/update?id=${category.id}">Update
                                        </button>
                                        <button class="btn btn-info" formaction="CategoryServlet/reset">Reset
                                        </button>
                                    </div>
                                </form>
                            </div>
