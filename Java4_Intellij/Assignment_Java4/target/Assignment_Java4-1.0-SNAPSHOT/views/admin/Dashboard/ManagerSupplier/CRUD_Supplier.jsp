                ...
                <form action="SupplierServlet" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="">PHone cung Cấp</label>
                                <label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Address cung Cấp</label>
                                <label>
                    ...
                    <div class="form-check mt-4">
                        <button class="btn btn-primary" formaction="SupplierServlet/store">Create</button>
                        <button class="btn btn-info" formaction="SupplierServlet/reset">Reset</button>
                    </div>
                </form>
            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger"
                                                    formaction="SupplierServlet/delete?id=${supplier.id}"
                                            >Xoá
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <form action="SupplierServlet" method="post">
                                    ...
                                    <div class="form-check mt-4">
                                        <button class="btn btn-warning"
                                                formaction="SupplierServlet/update?id=${supplier.id}">Update
                                        </button>
                                        <button class="btn btn-info" formaction="SupplierServlet/reset">Reset
                                        </button>
                                    </div>
                                </form>
                            </div>
