        ...
        <li class="pb-3">
          ...
          <ul id="collapseThree" class="collapse list-unstyled pl-3">
            <c:forEach items="${category}" var="c">
              <li><a class="text-decoration-none" href="#">${c.nameCategory}</a></li>
            </c:forEach>
          </ul>
        </li>
      </ul>
        ...
        <c:forEach var="i" items="${listA}">
          <div class="col-md-4">
            <div class="card mb-4 product-wap rounded-0">
              ...
              <div class="card-body">
                <a href="shop-single.html" class="h3 text-decoration-none">${i.nameProduct}</a>
      ...
      <div div="row">
        <ul class="pagination pagination-lg justify-content-end">
          <c:forEach begin="1" end="${endP}" var="i">
            <li class="page-item">
              <a class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark ${tag == i ? "active" : ""}" href="/Assignment_Java4_war/ProductsServlet?index=${i}">${i}</a>
            </li>
          </c:forEach>
