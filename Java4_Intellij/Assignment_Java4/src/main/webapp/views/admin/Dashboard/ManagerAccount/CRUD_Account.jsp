            ...
            <div class="modal-body">
                <form action="AccountServlet" method="post">
                    ...
                    <div class="form-check mt-4">
                        <button class="btn btn-primary" formaction="AccountServlet/store">Create</button>
                        <button class="btn btn-info" formaction="AccountServlet/reset">Reset</button>
                    </div>
                </form>
            </div>
            ...
            <c:forEach items="${account}" var="account">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger"
                                                    formaction="AccountServlet/delete?id=${account.id}"
                                            >Xoá
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="exampleModal_edit${account.id}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel_edit${account.id}">Modal
                                    title</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                                ...
                                <form action="AccountServlet" method="post">
                                    ...
                                    <div class="form-check mt-4">
                                        <button class="btn btn-warning"
                                                formaction="AccountServlet/update?id=${account.id}">Update
                                        </button>
                                        <button class="btn btn-info" formaction="AccountServlet/reset">Reset
                                        </button>
                                    </div>
                                </form>
