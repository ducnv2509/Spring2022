...
@WebServlet(name = "LoadServletByAjax", value = "/load")
public class LoadServletByAjax extends HttpServlet {
    ListProductsDAO productsDAO;

    public LoadServletByAjax() {
        ...
        for (Products o : list
            ...
            out.println(
                    "<div class=\"product col-md-4\">\n" +
                            ...
                            "                                        <li><a class=\"btn btn-success text-white mt-2\"\n" +
                            "                                               href=\"/Assignment_Java4_war/addCart?id=" + o.getId() + "\"><i\n" +
